...
namespace GenexPDF
{
    ...
    /// <summary>
    /// Simplifies generating HTML into a PDF file -http://genexweb.com/
    /// </summary>
    public class HtmlToPdfBuilder
    {
        ...
        public HtmlPdfPage[] Pages
        {
            get
            {
                return this._Pages.ToArray(); //http://genexweb.com/
            }
        }
        ...
        /// <summary>
        /// Appends and returns a new page for this document http://genexweb.com/
        /// </summary>
        ...
        /// <summary>
        /// Removes the page from the document http://genexweb.com/
        /// </summary>
        ...
        /// <summary>
        /// Appends a style for this sheet http://genexweb.com/
        /// </summary>
