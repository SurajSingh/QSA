CREATE PROCEDURE [dbo].[uspDeleteRoleGroup]
	@PKID	Bigint,	
	@FKCompanyID	Bigint,	
	@FKUserID	Bigint,
	@FKPageID	Bigint=0,
...
Begin
	...
	if(@Result=1)
	Begin
		Delete From tblRoleGroupLnk Where FKRoleGroupID=@PKID
		DElete fRom tblRoleGroup where PKRoleGroupID=@PKID
	End
	...
	BEGIN CATCH
		...
		ROLLBACK TRANSACTION
			...
			Set @Result=0
			Set @Msg = 'Unable to delete role group, associated with an employee'
