CREATE PROCEDURE [dbo].[uspDeleteProjectBudget]
	@PKID	Bigint,	
	@FKCompanyID	Bigint,	
	@FKUserID	Bigint,
	@FKPageID	Bigint=0,
...
Begin
	...
	Select @count=count(*) From tblProjectBudget Where PKID=@PKID and FKCompanyID=@FKCompanyID
	if(@count=0)
	Begin
		Set @Result=0
	...
	Begin
				...
				Delete From tblBudgetDetail Where FKBudgetID=@PKID
				Delete From tblProjectBudget where PKID=@PKID
