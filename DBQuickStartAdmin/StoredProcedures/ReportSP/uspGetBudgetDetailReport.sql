CREATE PROCEDURE [dbo].[uspGetBudgetDetailReport]
	@PageSize			bigint=0,
	@PageNo				Bigint=0,
	@SortBy				Varchar(200),
	@SortDir			Varchar(50),
...
Begin
	...
	T1.Hrs as TimesheetHrs,Emp.FName+'' ''+Emp.LName as EmpName,emp.LoginID
	From 
	tblBudgetDetail A1
	...
	Left Join  tblTimeSheet T1 on T1.ApproveStatus=''Approved'' 	and T1.FKProjectID=A.FKProjectID and T1.TaskDate between A.FromDate and A.ToDate and T1.FKTaskID=A1.FKTaskID
	Left Join tblUser Emp on T1.FKEmpID=emp.PKUserID
