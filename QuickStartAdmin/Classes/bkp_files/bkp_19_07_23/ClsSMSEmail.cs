...
namespace QuickStartAdmin.Classes
{
    public class ClsSMSEmail
    {
        ...
        public void SendScheduleEmail(Int64 PKID, Int64 FKCompanyID, string CType, Int64 FKSMSLocationID, Int64 FKUserID, Int64 FKPageID)
        {
            ...
            if (dsTemp.Tables[0].Rows.Count > 0 && ds.Tables[0].Rows.Count > 0 && Convert.ToBoolean((dsTemp.Tables[0].Rows[0]["EnableEmail"])))
            {
                ...
                {
                    ClsSendSMSEmail.SendEmailAsync(obReturn);
                }
        ...
        public void SendLeaveEmail(Int64 PKID, Int64 FKCompanyID, string CType, Int64 FKSMSLocationID, Int64 FKUserID, Int64 FKPageID)
        {
            blCompany objdaCompany = new blCompany();
            objdaCompany.PKCompanyID = FKCompanyID;
            DataSet dsTemp = objdaCompany.GetEmailTemplate(FKSMSLocationID);
        ...
        public void SendAppointmentEmail(Int64 PKID, Int64 FKCompanyID, string CType, Int64 FKSMSLocationID, Int64 FKUserID, Int64 FKPageID)
        {
            blCompany objdaCompany = new blCompany();
            objdaCompany.PKCompanyID = FKCompanyID;
            DataSet dsTemp = objdaCompany.GetEmailTemplate(FKSMSLocationID);
