<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="InvoiceListArchive.aspx.cs" Inherits="QuickStartAdmin.Users.InvoiceListArchive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Archived Invoice List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Archived Invoice List</a></li>
    ...
    <script src="UserJs/Billing/InvoiceListArchive.js?version=<%=PageVersion%>"></script>
</asp:Content>
