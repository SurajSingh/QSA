...
namespace QuickStartAdmin.Users
{
    public partial class Designations : System.Web.UI.Page
    {
        ...
        public static string GetData(Int64 PageSize, Int64 OffSet, string SortBy, string SortDir, Int64 PKDeptID)
        {
            string result = "";
            ...
            else
            {
                ...
                DataSet ds = objda.GetDesignation(PageSize, OffSet, SortBy, SortDir, PKDeptID, "", Convert.ToInt64(HttpContext.Current.Session["OrgID"]));
