<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="QuickStartAdmin.Users.Departments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Add New Department</span></h4>
    ...
    <%--<div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Departments</h4>
                    ...
                    <table id="tbldata" class="dataTable  genexcustomtable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <thead>
                            <tr class="headmain">
                                ...
                                <th data-column="DeptDesc" class="sorting tdDeptDesc">Description</th>
    ...
    <!-- end row -->
    <script src="UserJs/Manage/Departments.js?version=23062022"></script>
</asp:Content>
