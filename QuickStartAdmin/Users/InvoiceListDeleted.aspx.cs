...
namespace QuickStartAdmin.Users
{
    public partial class InvoiceListDeleted : System.Web.UI.Page
    {
        ...
        public static string GetData(Int64 PageSize, Int64 OffSet, string SortBy, string SortDir, string daterange, string FromDate, string ToDate, Int64 PKID, string FKProjectID, string FKClientID, string InvoiceID)
        {
            string result = "";
            ...
            else
            {
                ...
                DataSet ds = objda.GetInvoiceDeleted(PageSize, OffSet, SortBy, SortDir, dresult.DateWise, dresult.fromdate, dresult.todate, PKID, Convert.ToInt64(HttpContext.Current.Session["OrgID"]), FKClientID, FKProjectID, InvoiceID,0);
        ...
        public static string DeleteData(Int64 PKID)
        {
            ...
            else
            {
                ...
                DataSet dsResult = objda.PermanentlyDeletedInvoice(PKID, Convert.ToInt64(HttpContext.Current.Session["OrgID"]));
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string RevokeData(Int64 PKID)
        {
            string result = "";
            if (!ClsLogin.ValidateLogin() || !ClsLogin.ValidateRole((Int32)ClsRoles.UserRoles.InvoiceList, PKID == 0 ? ClsRoles.IsAdd : ClsRoles.IsEdit))
            {
            ...
            else
            {
                ...
                objda.IPAddress = Classes.ClsLogin.GetRequestIP();
                objda.FKPageID = (Int64)ClsPages.WebPages.InvoiceList;
                DataSet dsResult = objda.RevokeDeletedInvoice(PKID, Convert.ToInt64(HttpContext.Current.Session["OrgID"]));
                result = objgen.SerializeToJSON(dsResult.Tables[0]);
