                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="navpills2-home" role="tabpanel">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4" id="ServiceAmtGroup" name="ServiceAmtGroup" >
                                    <div class="mb-3">
                                        <label class="form-label" id="ServiceAmt" >Service Amt: <span id="ServiceAmtRequired">*</span></label>
                                        <input class="form-control" placeholder="0.00" id="txtServiceAmt" />
                                    </div>
                                </div>
                                <div class="col-lg-4" id="ExpAmtGroup" name="ExpAmtGroup" >
                                    <div class="mb-3">
                                        <label class="form-label" id="ExpAmt" >Exp Amt:</label>
                                        <input class="form-control" placeholder="0.00" id="txtExpAmt" />
                                    </div>
                                </div>
                                <div class="col-lg-4" id="ContractAmtGroup" name="ContractAmtGroup" >
								<!--:(<%=StrCurrency %>) *removed frm below three lable-->
                                    <div class="mb-3">
                                        <label class="form-label" id="ContractAmt" >Contract Amt: <span id="ContractAmtRequired">*</span></label>
                                        <input class="form-control" placeholder="0.00" id="txtContractAmt" readonly/>
                                    </div>
                                </div>                               
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Start Date: <span id="StartdateRequired">*</span></label>
                                        <input type="text" class="form-control" id="txtStartdate" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Due Date: <span id="DueDateRequired" >*</span></label>
                            ...
                            <div class="row">
                                <!--<div class="col-lg-4" id="CompletePercentGroup" name="CompletePercentGroup">
                                    <div class="mb-3">
                                        <label class="form-label" id="CompletePercent">% Complete: <span id="CompletePercentRequired">*</span></label>
                                        <input class="form-control" placeholder="0" id="txtCompletePercent" />
                                    </div>
                                </div>--> <!--Commented the above code as suggested by Ankit on 4th July 2024-->
                                <div id="BudgetedHoursGroup" name="BudgetedHoursGroup" class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Budgeted Hours: <span id="BudgetedHoursRequired">*</span></label>
                                        <input class="form-control" placeholder="0.00" id="txtBudgetedHours" />
                                    </div>
                                </div>
                                <!--Added by Nilesh to show the bill as per billing frequency - start -->
                                 <div id="billCycleAmtGroup" name="billCycleAmtGroup"  class="col-lg-4" >								
                                    <div class="mb-3">
                                        <label class="form-label" id="billCycleAmt">Recurring Amt: <span id="billCycleAmtRequired">*</span></label>
                                        <input class="form-control" placeholder="0.00" id="txtbillCycleAmt"/>
                                    </div>
                                </div>
                                <!--Added by Nilesh to show the bill as per billing frequency - End -->
                    ...
                    <div class="tab-pane" id="navpills2-profile" role="tabpanel">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Billing Frequency: <span id="FKBillingFrequencyRequired">*</span></label>
