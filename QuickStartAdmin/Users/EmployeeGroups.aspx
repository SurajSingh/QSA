<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="EmployeeGroups.aspx.cs" Inherits="QuickStartAdmin.Users.EmployeeGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Add New Employee Group</span></h4>
            ...
            <div class="divpopup-inner">
                ...
                <div class="row mr-t-50">
                    <div class="font-size-16">
                        <label class="form-label">Select Employees in the group : *</label>
    ...
    <div class="modal-dialog modal-sm divpopup" id="divView" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Employee Group Detail</span></h4>
                <button type="button" class="close" onclick="closediv();"><span aria-hidden="true">×</span></button>
            </div>
            <div class="divpopup-inner">
    ...
    <%--<div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Employee Group</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Employee Group</a></li>
    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Employee Group</h4>
                    ...
                    <table id="tbldata" class="dataTable  genexcustomtable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr class="headmain">
                                ...
                                <th data-column="ChildCount" class="sorting tdChildCount">No. of Employees</th>
    ...
    <!-- end row -->
    <script src="UserJs/Groups/EmployeeGroups.js?version=<%=PageVersion%>"></script>
</asp:Content>
