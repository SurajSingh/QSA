<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptBudgetDetailbyProjectEmployee.aspx.cs" Inherits="QuickStartAdmin.Users.RptBudgetDetailbyProjectEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Budget Detail by Project Employee</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Budget Report</a></li>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div>
                <div class="divreport">
                    <iframe id="ifReport" src="Reports/BudgetReport.aspx" class="ifReport" style="margin: 0px; padding: 0px; height: 800px;"></iframe>
    ...
    <script src="UserJs/Reports/BudgetReport/RptBudgetSummaryReport.js"></script>
</asp:Content>
