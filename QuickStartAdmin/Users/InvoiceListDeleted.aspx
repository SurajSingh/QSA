<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="InvoiceListDeleted.aspx.cs" Inherits="QuickStartAdmin.Users.InvoiceListDeleted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Deleted Invoice List</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Deleted Invoice List</a></li>
    ...
    <script src="UserJs/Billing/InvoiceListDeleted.js?version=<%=PageVersion%>"></script>
</asp:Content>
