<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptApprovedTimeandExpenseswithMemos.aspx.cs" Inherits="QuickStartAdmin.Users.RptApprovedTimeandExpenseswithMemos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Approved Time and Expenses with Memos</h4>
    ...
    <script src="UserJs/Reports/BillingReport/RptApprovedTimeandExpenseswithMemos.js"></script>
</asp:Content>
