<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptAHoursBHoursComparisonbyEmployee.aspx.cs" Inherits="QuickStartAdmin.Users.RptAHoursBHoursComparisonbyEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">A-Hours B-Hours Comparison by Employee</h4>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div>
                <div class="divreport">
                    <iframe id="ifReport" src="Reports/AnalysisReport.aspx" class="ifReport" style="margin: 0px; padding: 0px; height: 800px;"></iframe>
    ...
    <script src="UserJs/Reports/Analysis/RptAHoursBHoursComparisonbyEmployee.js"></script>
</asp:Content>
