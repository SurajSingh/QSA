...
{
    public partial class InvoiceEmailTemplate : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (ClsLogin.ValidateRedirect((Int32)ClsRoles.UserRoles.InvoiceEmailTemplate, ""))
            {
        ...
        {
            string result = "";
            if (!ClsLogin.ValidateLogin() || !ClsLogin.ValidateRole((Int32)ClsRoles.UserRoles.InvoiceEmailTemplate, ClsRoles.IsEdit))
            {
        ...
        {
            string result = "";
            if (!ClsLogin.ValidateLogin() || !ClsLogin.ValidateRole((Int32)ClsRoles.UserRoles.InvoiceEmailTemplate, ClsRoles.IsAdd))
            {
