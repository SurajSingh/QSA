<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="LeaveRequestEmailReceivers.aspx.cs" Inherits="QuickStartAdmin.Users.LeaveRequestEmailReceivers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Leave Request Emails</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Company Settings</a></li>
                        <li class="breadcrumb-item active">Leave Request Emails</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mr-t-50">
                        <div class="font-size-16">
                            Select Receivers for Leave Request Emails :<br>
                            <br>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
    ...
    <script src="UserJs/CompanySettings/LeaveRequestEmailReceivers.js"></script>
</asp:Content>
