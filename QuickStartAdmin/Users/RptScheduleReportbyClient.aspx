<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptScheduleReportbyClient.aspx.cs" Inherits="QuickStartAdmin.Users.RptScheduleReportbyClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Schedule Report by Client</h4>
                        ...
                        <table id="tbldata" class="dataTable  genexcustomtable">
                            ...
                            <thead>
                                <tr class="headmain">
                                    ...
                                    <th data-column="EmpList" class="sorting tdEmpList">Employee</th>
    ...
    <script src="UserJs/Reports/ScheduleReport/RptScheduleReportbyClient.js?version=27022023"></script>
</asp:Content>
