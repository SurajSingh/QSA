...
var json;
var pagename = "/Users/AttandenceMachineSettings.aspx";
var PKID = 0;
...
function FunValidate() {
    ...
    if ($("#txtAttenUserName").val() == "") {
        fail = true;
        $("#txtAttenUserName").css("border-color", ColorE);
        strError += "<li>Enter Username</li>";
    }
    else {
        $("#txtAttenUserName").css("border-color", ColorN);
    }
    if ($("#txtAttenPWD").val() == "") {
        fail = true;
        $("#txtAttenPWD").css("border-color", ColorE);
        strError += "<li>Enter Password</li>";
    }
    else {
        $("#txtAttenPWD").css("border-color", ColorN);
    }
...
function FunSave() {
    ...
    var args = {
        AttenUserName: $("#txtAttenUserName").val(), AttenPWD: $("#txtAttenPWD").val()
...
function FunFillDetail(jsonarr) {
    ...
    $('#txtAttenUserName').val(jsonarr[0].AttenUserName);
    $('#txtAttenPWD').val(jsonarr[0].AttenPWD);
