                ...
                if (jsonarr.data.Table.length > 0) {
                    if (jsonarr.data.Table[0].Result == "1") {
                        ...
                        if (ExportType == null || ExportType == "") {
                            ...
                            //FunFillDetail(jsonarr.data.Table);
                        }
                    }
...
function FunFillDetail(jsonarr) {
    ...
    PKID = jsonarr.data.Table[0].PKDeptID;
    $("#txtDepartment").val(jsonarr.data.Table[0].DeptName);
    $("#txtDesc").val(jsonarr.data.Table[0].DeptDesc);
