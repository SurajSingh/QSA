...
var json;
var pagename = "/Users/ExpenseGroups.aspx";
var PKID = 0;
var jsonList = null;
...
function FunFillDetail(jsonarr) {
    FunBlank();
    $('#popupTitle').find('span').html("Modify Expense Group");
...
function FunFillGroupDetail(jsonarr) {
    ...
    $.each(jsonarr.data.Table1, function (i, item) {
        str += '<tr><td><i class="fa fa-angle-right"></i>&nbsp;' + item.TaskCodeName + '</td></tr>';
...
function FunBlank() {
    ...
    $('#popupTitle').find('span').html("New Expense Group");
...
function PageLoadFun() {
    ...
    FunGetTaskForAutoComplete(FunListCallback, 0,0,'E', 'Active');
    InitilizeEvents();
    FunSetTabKey();
    FunFillData($("#tbldata").GenexTableGetPageSize(), 0, "", "D", "", "");
