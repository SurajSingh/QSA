...
namespace QuickStartAdmin.Users
{
    public partial class TaxMaster : System.Web.UI.Page
    {
        ...
        public static string GetData(Int64 PageSize, Int64 OffSet, string SortBy, string SortDir, Int64 PKID)
        {
            string result = "";
            ...
            else
            {
                ...
                DataSet ds = objda.GetTaxMaster(PageSize, OffSet, SortBy, SortDir, PKID, "", Convert.ToInt64(HttpContext.Current.Session["OrgID"]));
                result = objgen.SerializeToJSON(ds); //objgen.SerializeToJSON(ds.Tables[0]);
            }
