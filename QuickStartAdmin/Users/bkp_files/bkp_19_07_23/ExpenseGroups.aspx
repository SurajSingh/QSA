<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="ExpenseGroups.aspx.cs" Inherits="QuickStartAdmin.Users.ExpenseGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Add New Expense Group</span></h4>
            ...
            <div class="divpopup-inner">
                ...
                <div class="row mr-t-50">
                    <div class="font-size-16">
                         <label class="form-label">Select Expenses in the group : *</label>
    ...
    <div class="modal-dialog modal-sm divpopup" id="divView" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Expense Group Detail</span></h4>
                <button type="button" class="close" onclick="closediv();"><span aria-hidden="true">×</span></button>
            </div>
            <div class="divpopup-inner">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Expense Group</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Expense Group</a></li>
    ...
    <!-- end row -->
    <script src="UserJs/Groups/ExpenseGroups.js?version=<%=PageVersion%>"></script>
</asp:Content>
