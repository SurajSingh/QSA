<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptAssetReportByEmployee.aspx.cs" Inherits="QuickStartAdmin.Users.RptAssetReportByEmployee" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Asset Report By Employee</h4>
