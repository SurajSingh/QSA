<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptExpensesbyClient.aspx.cs" Inherits="QuickStartAdmin.Users.RptExpensesbyClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Expenses by Client</h4>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3 mar">
                                ...
                                <input type="hidden" id="HidBilled" value="1" />
                            </div>
                              <div class="col-sm-3 mar">
                                <label>Billed:</label>
                                <select id="dropBilledSrch" class="form-control">
                                    <option value="">All</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
    ...
    <script src="UserJs/Reports/ClientReport/RptExpensesbyClient.js"></script>
</asp:Content>