...
namespace QuickStartAdmin.Users.Reports
{
    public partial class ClientReport : System.Web.UI.Page
    {
        ...
        public void FillReport()
        {
            ...
            if (Convert.ToInt64(HidPageID.Value) == (Int64)ClsPages.WebPages.ClientMasterFileList)
            {
                StrReportName = "ClientMasterFileList";
                path = AppDomain.CurrentDomain.BaseDirectory + "\\Users\\RDLC\\DesignFiles\\Reports\\ClientReport\\ClientMasterFileList.rdlc";
            }
            else if (Convert.ToInt64(HidPageID.Value) == (Int64)ClsPages.WebPages.ClientMasterFileDetails)
            {
                StrReportName = "ClientMasterFileDetails";
                path = AppDomain.CurrentDomain.BaseDirectory + "\\Users\\RDLC\\DesignFiles\\Reports\\ClientReport\\ClientMasterFileDetails.rdlc";
            }


            ds = objda.GetClient(0, 0, "", "", 0, Convert.ToInt64(HttpContext.Current.Session["OrgID"]), HidClientName.Value, HidActiveStatus.Value);
