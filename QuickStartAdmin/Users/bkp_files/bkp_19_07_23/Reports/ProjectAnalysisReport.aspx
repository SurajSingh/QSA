<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Reports/ReportMaster.Master" AutoEventWireup="true" CodeBehind="ProjectAnalysisReport.aspx.cs" Inherits="QuickStartAdmin.Users.Reports.ProjectAnalysisReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <asp:HiddenField ID="HidProjectID" runat="server" ClientIDMode="Static" Value="0" />
    <asp:HiddenField ID="HidProject" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidClient" runat="server" ClientIDMode="Static" Value="0" />
    <asp:HiddenField ID="HidStatus" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidContractType" runat="server" ClientIDMode="Static" Value="0" />
    ...
    <script type="text/javascript">
        window.SearchReport = function (args) {
            $("#HidProject").val(args[0]);
            $("#HidClient").val(args[1]);
            $("#HidStatus").val(args[2]);
            $("#HidContractType").val(args[3]);
            $("#HidProjectID").val(args[4]);
