<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Reports/ReportMaster.Master" AutoEventWireup="true" CodeBehind="TimeExpensesDetailbyClientProject.aspx.cs" Inherits="QuickStartAdmin.Users.Reports.TimeExpensesDetailbyClientProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="HidEmpID" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidBillable" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidApproved" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidFKManagerIDSrch" runat="server" ClientIDMode="Static" Value="0" />
    <asp:HiddenField ID="HidBilledSrch" runat="server" ClientIDMode="Static" Value="" />
    <asp:HiddenField ID="HidRecType" runat="server" ClientIDMode="Static" Value="" />
     <asp:HiddenField ID="HidWithCost" runat="server" ClientIDMode="Static" Value="0" />
    ...
    <script type="text/javascript">
        window.SearchReport = function (args) {
            ...
            $("#HidEmpID").val(args[5]);
            $("#HidBillable").val(args[6]);
            $("#HidApproved").val(args[7]);
            $("#HidFKManagerIDSrch").val(args[8]);
            $("#HidBilledSrch").val(args[9]);
            $("#HidRecType").val(args[10]);
            $("#HidWithCost").val(args[11]);
            $("#HidPageID").val(args[12]);
