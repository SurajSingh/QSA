...
{
    public partial class RptScheduleReportbyClient : System.Web.UI.Page
    {
        public string PageVersion = "13062022";
        public string StrCurrency = "$";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (ClsLogin.ValidateRedirect((Int32)ClsRoles.UserRoles.ScheduleReportbyClient, ""))
            {
                ((HiddenField)this.Master.FindControl("HidPageRoleID")).Value = ((Int32)ClsRoles.UserRoles.ScheduleReportbyClient).ToString();
                ((HiddenField)this.Master.FindControl("HidPageID")).Value = ((Int32)ClsPages.WebPages.ScheduleReportbyClient).ToString();
            }
        }
        [WebMethod]
