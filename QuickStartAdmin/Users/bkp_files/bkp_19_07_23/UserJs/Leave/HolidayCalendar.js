...
var json;
var pagename = "/Users/HolidayCalendar.aspx";
var PKID = 0;
...
function FunBlank() {
    ...
    $('#popupTitle').find('span').html("New Holiday");
...
function FunSave() {
    ...
    var args = {
        PKID: PKID, HolidayDate: $("#txtDate").val(),
        Name: $("#txtName").val(), Desc: $("#txtDesc").val()
                    ...
                    if (jsonarr[0].Result == "1") {
                        if (PKID == 0) {
                            $.each(jsonarr, function (i, item) {
                                ...
                                str = str + '<tr>';
                                str = str + '<td>' + item.HolidayDate + '</td>';
                                str = str + '<td>' + item.HolidayName + '</td>';
                                str = str + '<td>' + item.HolidayDesc + '</td>';
...
function FunFillDetail(jsonarr) {
    FunBlank();
    $('#popupTitle').find('span').html("Modify Holiday");
    PKID = jsonarr[0].PKID;
    $("#txtDate").val(jsonarr[0].HolidayDate);
    $("#txtName").val(jsonarr[0].HolidayName);
    $("#txtDesc").val(jsonarr[0].HolidayDesc);
    opendiv('divAddNew');
}
