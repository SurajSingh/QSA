<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptProjectForecastingReport.aspx.cs" Inherits="QuickStartAdmin.Users.RptProjectForecastingReport" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Project Forecasting Report</h4>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-sm-3 mar">
                                   ...
                                   <input type="hidden" id="HidRecType" value="TaskSearch" />
