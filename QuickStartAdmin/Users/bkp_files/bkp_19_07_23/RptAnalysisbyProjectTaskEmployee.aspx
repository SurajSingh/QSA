<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptAnalysisbyProjectTaskEmployee.aspx.cs" Inherits="QuickStartAdmin.Users.RptAnalysisbyProjectTaskEmployee" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Analysis by Project, Task And Employee</h4>
                ...
                <div class="card-body">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3 mar" style="display:none;">
                                <label>Task Type:</label>
                                <select id="dropTaskTypeSrch" class="form-select">
                                    <option value="">All</option>
                                    <option value="Task" selected="selected">Service</option>
