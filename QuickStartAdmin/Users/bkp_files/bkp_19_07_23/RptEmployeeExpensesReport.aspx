<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="RptEmployeeExpensesReport.aspx.cs" Inherits="QuickStartAdmin.Users.RptEmployeeExpensesReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Employee Expenses by Item</h4>
    ...
    <script src="UserJs/Reports/EmployeeReport/RptEmployeeExpensesbyItem.js"></script>
</asp:Content>
