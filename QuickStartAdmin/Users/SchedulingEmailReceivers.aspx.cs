...
{
    public partial class SchedulingEmailReceivers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (ClsLogin.ValidateRedirect((Int32)ClsRoles.UserRoles.SchedulingEmailReceivers, ""))
            {
        ...
        {
            string result = "";
            if (!ClsLogin.ValidateLogin() || !ClsLogin.ValidateRole((Int32)ClsRoles.UserRoles.SchedulingEmailReceivers, ClsRoles.IsEdit))
            {
        ...
        {
            string result = "";
            if (!ClsLogin.ValidateLogin() || !ClsLogin.ValidateRole((Int32)ClsRoles.UserRoles.SchedulingEmailReceivers, ClsRoles.IsAdd))
            {
