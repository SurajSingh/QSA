...
namespace QuickStartAdmin.Users
{
    public partial class InvoiceList : System.Web.UI.Page
    {
        ...
        public static string SaveData(Int64 PKID, string ApproveAction, string ApproveRemark)
        {
            string result = "";
            int status = 1;

            Int64 FKUserEmpID = Convert.ToInt64(HttpContext.Current.Session["UserID"]);
            ...
            if (status == 1)
            {
                ...
                DataSet dsResult = objda.ApproveInvoices(PKID, FKUserEmpID, ApproveAction, ApproveRemark,Convert.ToInt64(HttpContext.Current.Session["OrgID"]));
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string GetData(Int64 PageSize, Int64 OffSet, string SortBy, string SortDir, string daterange, string FromDate, string ToDate, Int64 PKID, string FKProjectID, string FKClientID, string InvoiceID, string PaymentStatus)
        {
            string result = "";
            ...
            else
            {
                ...
                DataSet ds = objda.GetInvoice(PageSize, OffSet, SortBy, SortDir, dresult.DateWise, dresult.fromdate, dresult.todate, PKID, Convert.ToInt64(HttpContext.Current.Session["OrgID"]), FKClientID, FKProjectID, InvoiceID,0, PaymentStatus);
