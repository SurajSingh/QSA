<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="ProjectGroups.aspx.cs" Inherits="QuickStartAdmin.Users.ProjectGroups" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Add New Project Group</span></h4>
            ...
            <div class="divpopup-inner">
                ...
                <div class="row mr-t-50">
                    <div class="font-size-16">
                        <label class="form-label">Select Projects in the group : *</label>
            ...
            <div class="divpopbutton">
                ...
                <input type="button" class="btn btn-secondary  waves-effect waves-light closeBtn" value="Close" id="btnClose" onclick="closediv();" />
    ...
    <div class="modal-dialog modal-sm divpopup" id="divView" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="bx bx-money font-size-18"></i>&nbsp;<span>Project Group Detail</span></h4>
                <button type="button" class="close" onclick="closediv();"><span aria-hidden="true">×</span></button>
            </div>
            <div class="divpopup-inner">
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Project Group</h4>
                    ...
                    <table id="tbldata" class="dataTable  genexcustomtable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr class="headmain">
                                ...
                                <th data-column="ChildCount" class="sorting tdChildCount">No. of  Projects</th>
    ...
    <!-- end row -->
    <script src="UserJs/Groups/ProjectGroups.js?version=<%=PageVersion%>"></script>
</asp:Content>
