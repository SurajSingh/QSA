<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="VendorMaster.aspx.cs" Inherits="QuickStartAdmin.Users.VendorMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="uil-file-plus font-size-18"></i>&nbsp;<span>Add New Vendor</span></h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="txtNotes" maxlength="500" style="height: 40px;"></textarea>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Vendors</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 mar">
                                        ...
                                        <input type="text" class="form-control" id="txtCompanyNameSrch" />
                                    </div>
                        ...
                        <table id="tbldata" class="dataTable  genexcustomtable">
                            ...
                            <thead>
                                <tr class="headmain">
                                    ...
                                    <th style="width: 20px;"></th>
                                    <th data-column="Code" class="sorting tdCode">Vendor Code</th>
    ...
    <script src="UserJs/AssetManagement/VendorMaster.js?version=<%=PageVersion%>"></script>
</asp:Content>
