<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.Master" AutoEventWireup="true" CodeBehind="TaskCodes.aspx.cs" Inherits="QuickStartAdmin.Users.TaskCodes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal-dialog modal-sm divpopup" id="divAddNew" style="width: 800px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="uil-file-plus font-size-18"></i>&nbsp;<span>Add Task Code</span></h4>
            ...
            <div class="divpopup-inner">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label" for="name">Task Code: *</label>
                            <input id="txtTaskCode" type="text" class="form-control" maxlength="40" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label class="form-label" for="email">Task Name: *</label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            ...
                            <select id="dropFKDeptID" class="form-select">
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label class="form-label">Bill Rate:(<%=StrCurrency %>)</label>
                            <input id="txtBillRate" type="text" class="form-control" />
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label class="form-label">Budgeted Hrs:</label>
                            <input id="txtBHours" class="form-control" />
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0" id="pagetitle">Task Codes</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Task Codes</a></li>
                        ...
                        <table id="tbldata" class="dataTable  genexcustomtable">
                            ...
                            <thead>
                                <tr class="headmain">
                                    ...
                                    <th data-column="BillRate" class="sorting tdBillRate tdclscurrency">Bill Rate</th>
    ...
    <script src="UserJs/Manage/TaskCodes.js?version=<%=PageVersion%>"></script>
</asp:Content>
