...
{
    public partial class ProjectAnalysisReport : System.Web.UI.Page
    {
        ...
        public void FillReport()
        {
            ...
            if (Convert.ToInt64(HidPageID.Value) == (Int64)ClsPages.WebPages.ProjectAnalysisReport)
            {
                path = AppDomain.CurrentDomain.BaseDirectory + "\\Users\\RDLC\\DesignFiles\\Reports\\Analysis\\ProjectAnalysisReport.rdlc";
                StrReportName = "ProjectAnalysisReport";
            }
            else if (Convert.ToInt64(HidPageID.Value) == (Int64)ClsPages.WebPages.PercentageBilled)
            {
                path = AppDomain.CurrentDomain.BaseDirectory + "\\Users\\RDLC\\DesignFiles\\Reports\\BillingReport\\PercentageBilled.rdlc";
                StrReportName = "PercentageBilled";
            }
          
          
            ds = objda.GetProject(0, 0, "ProjectName", "", Convert.ToInt64(HidProjectID.Value), Convert.ToInt64(HttpContext.Current.Session["OrgID"]),HidProject.Value, Convert.ToInt64(HidClient.Value), HidStatus.Value, Convert.ToInt64(HidContractType.Value));
