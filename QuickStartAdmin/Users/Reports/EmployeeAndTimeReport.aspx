<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Reports/ReportMaster.Master" AutoEventWireup="true" CodeBehind="EmployeeAndTimeReport.aspx.cs" Inherits="QuickStartAdmin.Users.Reports.EmployeeAndTimeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="HidApproved" runat="server" ClientIDMode="Static" Value="" />
      <asp:HiddenField ID="HidBilled" runat="server" ClientIDMode="Static" Value="" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="display: none;">
                <asp:Button ID="btnViewReport" runat="server" Text="Search" OnClick="btnViewReport_Click" ClientIDMode="Static" /></div>
    ...
    <script type="text/javascript">
        window.SearchReport = function (args) {
            ...
            $("#HidBilled").val(args[8]);
            $("#HidPageID").val(args[9]);
