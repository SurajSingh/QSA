<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Reports/ReportMaster.Master" AutoEventWireup="true" CodeBehind="ProjectForcastingReport.aspx.cs" Inherits="QuickStartAdmin.Users.Reports.ProjectForcastingReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="txtFKProjectID" runat="server" ClientIDMode="Static" Value="0" />
    <asp:HiddenField ID="txtRecType" runat="server" ClientIDMode="Static" Value="" />  
    ...
    <script type="text/javascript">
        window.SearchReport = function (args) {
            $("#txtFKProjectID").val(args[0]);
            $("#txtRecType").val(args[1]);
