...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!--Added by nilesh to show the unbilled task and expenses on the popup - End - 23/04/24 -->
     ...
     <div class="modal-dialog modal-sm divpopup" id="divSubmit" style="width: 500px; display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="popupTitle"><i class="bx bx-user font-size-18"></i>&nbsp;<span>Submit Inovice For Approval</span></h4>
                <button type="button" class="close" onclick="closediv();"><span aria-hidden="true">×</span></button>
            </div>
                                            ...
                                            <div class="invoice-txtbox clearfix">
                                                <div class="invc-lft-txt">
                                                    <ul id="ulProjectContract">
                                                        ...
                                                        <li id="liBudgetedHour">Budgeted Hours : <span id="spanbudgetedhours">-</span></li>
                                                        <li id="liBilledHours">Billed Hours : <span id="spanbilledhours">-</span></li>
                                                        <li id="liAvailableHours">Available Hours : <span id="spanavailablehours">-</span></li>
                                                        <li id="liContractAmt">Contract Amt. : <span id="spancontractamt">-</span></li>
                                                        <li id="liServiceAmt">Service Amt. : <span id="spanserviceamt1">-</span></li>
                                                        <li id="liExpenseAmt">Expenses Amt. : <span id="spanexpamt1">-</span></li>
                                                        <li id="liAvailableAmt">Available Amt. : <span id="spanavailamt">-</span></li>
                                                         <li id="liRecurringAmt">Recurring Amt. : <span id="spanrecurringamt">-</span></li>
                                                         <li id="liSkippedCycle">Skipped Cycle. : <span id="spanskippedcycle">-</span></li>
                                                        <li id="liRecLimit">Recurring Amt Limit. : <span id="spanreclimit">-</span></li>
                                                        <li>Invoiced Amt. : <span id="spaninvamt">-</span></li>
                                                        <li id="liProjectPercent">% Complete : <span id="spanpercomplete">-</span></li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <a class="accordion-button collapsed"
                                            ...
                                            aria-expanded="false" aria-controls="collapseFour">Invoice Details
                                        </a>
                                    </h2>
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <div class="invoice-txtbox clearfix">
                                                ...
                                                <div class="invc-lft-txt">
                                                    <ul id="ulInvDetails">
                                                        <li>Service Amt. :  <span id="txtServiceAmount">-</span></li>
                                                        <li>Expense Amt. :  <span id="txtExpenseAmount">-</span></li>
                                                        <li style="border:1px solid black;border-right:0;border-left:0;margin-top:2px;margin-bottom:10px;"><b>Sub Total :  <span id="txtSubTotal">-</span></b></li>
                                                        <li>Discount :  <input type="text" placeholder="-" style="float:right;margin-right:0;border-top: solid 1px #CCCC;width: 32%;border-right: solid 1px #CCCC;border-left: solid 1px #CCCC;text-align: right;height:24px;" id="txtDiscount"></input></li>
                                                        <li style="border:1px solid black;border-right:0;border-left:0;margin-top:2px;margin-bottom:10px;"><b>Sub Total After Discount :  <span id="txtSubTotalAfterDiscount">-</span></b></li>
                                                        <!--<li>&nbsp;</li>-->
				                                        <li>Tax :  <select id="dropFKTaxID" style="float:right;margin-right:0;border:0;" disabled="disabled"></select></li>
				                                        <li>Tax % :  <span id="txtTaxPer" disabled="disabled">-</span></li>
				                                        <li style="border:1px solid black;border-right:0;border-left:0;margin-top:2px;margin-bottom:10px;"><b>Tax Amount :  <span id="txtTotalTax">-</span></b></li>
                                                        <!--<li>&nbsp;</li>-->
				                                        <!--Removed Discount input from here -->
				                                        <li>Retainer (C) :  <span id="txtReceived">-</span></li>
				                                        <li style="border:1px solid black;border-right:0;border-left:0;margin-top:2px;margin-bottom:10px;"><b>Total :  <span id="txtNetAmt">-</span></b></li>
                                                        <!--<li>&nbsp;</li>-->
				                                        <li>Paid :  <span id="txtpaidamount">-</span></li>
				                                        <li>Amount Due :  <span id="txtNetDueAmt">-</span></li>
				                                        <li>Retainage :  <span id=txtRetainage">-</span></li>
                                                    </ul>
                                                </div>
                   ...
                   <div id="divtotalsummary" style="">
	                    ...
	                    <div class="invoice-txtbox clearfix">
		                    ...
		                    <div class="invc-rht-txt">
			                    <ul>
				                    <li>
					                    <select name="dropFKTaxID" id="dropFKTaxID" class="form-select" disabled></select>
				                    </li>
				                    <li>
	                    ...
	                    <div class="invoice-txtbox clearfix">
		                    ...
		                    <div class="invc-rht-txt">
			                    <ul>
				                    ...
				                    <li><span>$</span>
					                    <input name="FNetAmt" type="text" id="FNetAmt" value="0" readonly="readonly"></li>
                                    ...
                                    <div class="col-lg-4">                                        
                                        <div class="row">
                                            <div class="col-12 col-lg-12">
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        <input name="rbtnShowInvoices" id="chkAllInvoices" type="radio" class="form-check-input" checked="checked">
                                                        <label class="form-check-label" for="chkAllInvoices">List All Task and Expenses</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>    
                                        <div class="row">
                                            <div class="col-12 col-lg-12">
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        <input name="rbtnShowInvoices" id="chkDateRange" type="radio" class="form-check-input" >
                                                        <label class="form-check-label" for="chkDateRange">List Task and Expenses by Date</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="invoiceDateRange" class="row" > <!--style ="display:none;"-->
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"  id="txtInvFromDate" />
                                            </div>
                                         </div>
                                        ...
                                        <div  class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"  id="txtInvEndDate" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="DetailPart">
                                    ...
                                    <div class="tablePart BottomRadius">
                                        <div class="summary">
                                            <ul>
                                                <li>Total Amt.: <span id="FTotalSubAmt">0</span></li>
                                                 ...
                                                 <li>Total Amt After Disc (-): <span id="FTotalAmtAfterDisc">0</span></li>
                                        ...
                                        <div class="RightLink addmore">
                                             <div class="row">
                                                 <a id="btnAddNew">
                                                    <i class="fa fa-fw fa-plus topicon"></i> Add Item&nbsp;&nbsp;
                                                 </a>
                                            </div>
                                            <div class="row">
