<%@ Page Title="" Language="C#" MasterPageFile="~/Appointment/MobileMaster.Master" AutoEventWireup="true" CodeBehind="MobDefault.aspx.cs" Inherits="QuickStartAdmin.Appointment.MobDefault" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mainfrom">
        <div class="graybox" id="div1">
            <div class="com-hding">
                <span>Welcome to  
                    <asp:Literal ID="litcompanyname" runat="server" Text="Harshwal & Company LLP"></asp:Literal>
                </span>
                <br />
        ...
        <div class="graybox2" style="display: none;" id="div2">
                    ...
                    <div class="button1" onclick="goprevious(1,2);" style="text-align:right;"><a>Back</a></div>
              <div class="clear"></div>
            <div class="leftbox">
        ...
        <div id="div3" class="graybox3" style="display: none;">
            <div class="rightbox">
                <div class="rightback">
                    <div class="button1"><a onclick="goprevious(2,3);">Back</a></div>
                </div>
                <div class="rightfrom">
                    ...
                    <div class="inputbox">
                        ...
                        <div class="fldbox">
                            ...
                            <select id="dropservice" class="w1">
                                ...
                                <option value="Cloud Apps Development">Cloud Apps Development</option>
                                ...
                                <option value="Citrix Support">Citrix Support</option>
                            </select>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function setappointment(id, id2, idTime) {
            ...
            $.ajax({
                ...
                url: "MobDefault.aspx/getEmpAvailabilitybyid",
                dataType: "json",
        ...
        function getAvailability() {
            ...
            if (status == 1) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json",
                    data: JSON.stringify(args1),
                    url: "MobDefault.aspx/getEmpAvailability",
                    dataType: "json",
                    success: function (data) {
        ...
        function saveappointment() {
            ...
            if (status == 1) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json",
                    data: JSON.stringify(args1),
                    url: "MobDefault.aspx/saveEmpAvailability",
                    dataType: "json",
                    success: function (data) {
