<%@ Page Title="" Language="C#" MasterPageFile="~/Appointment/AppointmentMaster.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="QuickStartAdmin.Appointment.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
                    ...
                    if (data.d != "failure") {
                        ...
                        if (jsonarr.length > 0) {
                            ...
                            for (var i in jsonarr) {
                                ...
                                document.getElementById("hidslabid").value = jsonarr[i].PKID;
                                document.getElementById("hidadate").value = jsonarr[i].OnDate;
                                document.getElementById("hidfromtime").value = jsonarr[i].FromTime;
                                document.getElementById("hidtotime").value = jsonarr[i].ToTime;
        ...
        function saveappointment() {
            ...
            if (status == 1) {
                $("div[id=ctl00_ContentPlaceHolder1_progress1_UpdateProg1]").show();
                var args1 = { sloatid: document.getElementById("hidslabid").value, empid: document.getElementById("dropcontactperson").value, aDate: document.getElementById("hidadate").value, frmTime: document.getElementById("hiselectedtime").value, ToTime: "", vName: document.getElementById("txtname").value, designation: document.getElementById("txtdesignation").value, company: document.getElementById("txtorg").value, email: document.getElementById("txtemail").value, contactno: document.getElementById("txtcontact").value, service: document.getElementById("dropservice").value, servicecompanyid: document.getElementById("app_hid_company").value };
                $.ajax({
                    type: "POST",
                    contentType: "application/json",
                    data: JSON.stringify(args1),
